...
<body>
    ...
    <form action="/storeProduct" method = "POST" enctype = "multipart/form-data">
        ...
        <div class="anggota">
            <div class="item">
                <p>Name</p>
                <input type="text" id="name" placeholder = "Caleo Shirt" name = "productname" value = "{{old('productname')}}">
                @error('productname')
            ...
            <div class="item">
                <p>Price</p>
                <input type="integer" id="price" placeholder = "100000" name="productprice" value = "{{old('productprice')}}">
                @error('productprice')
                    <div class = "alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="item">
                <p>Quantity</p>
                <input type="integer" name = "productqty" id="qty" placeholder = "10" value = "{{old('productqty')}}">
            ...
            <div class="item">
                <p>Image</p>
                <input type="file" id="image" class = "form-control form-control-sm" name = "productimg" value = "{{old('productimg')}}">
                @error('productimg')
                    <div class = "alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
